...
config :print_client, PrintClientWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "1Kpfe+5AgOFWmNF8zm1RDGslpFhml61YCvwTmGzTR9bxJW0HU/IBSRcoZNeVMr86",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:print_client, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:print_client, ~w(--watch)]}
  ]
