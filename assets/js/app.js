...
window.addEventListener("phx:show-dialog-modal", e => document.getElementById(e.detail.id)?.showModal())
window.addEventListener("phx:hide-dialog-modal", e => document.getElementById(e.detail.id)?.close())
